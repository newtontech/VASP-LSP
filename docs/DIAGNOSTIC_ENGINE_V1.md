...
```bash
vasp-lsp-tool check path/to/input --format json
vasp-lsp-tool context path/to/input --format json
vasp-lsp-tool complete path/to/input --format json
vasp-lsp-tool hover path/to/input --format json
vasp-lsp-tool symbols path/to/input --format json
vasp-lsp-tool fix path/to/input --format json
```
